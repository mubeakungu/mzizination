...
<div class="kt-subheader kt-grid__item" id="kt_subheader">
    <div class="kt-subheader__main">
        <h3 class="kt-subheader__title">Создать турнир</h3>
    </div>
</div>
    ...
    <div class="kt-portlet">
        <div class="kt-portlet__head">
            <div class="kt-portlet__head-label">
                <h3 class="kt-portlet__head-title">Добавление нового турнира</h3>
            </div>
        </div>
        ...
        <form method="POST" action="{{ route('admin.tournaments.create') }}">
            @csrf
            <div class="kt-portlet__body">
                <div class="form-group">
                    <label>Название турнира <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" name="title" value="{{ old('title') }}" required maxlength="50" placeholder="Например: Новогодний турнир 2024">
                    <span class="form-text text-muted">Максимум 50 символов</span>
                </div>

                <div class="form-group">
                    <label>ID игр (через запятую) <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" name="games" value="{{ old('games') }}" required placeholder="1, 2, 3, 5, 10">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="awards" value="{{ old('awards') }}" required placeholder="10000, 5000, 3000, 2000, 1000">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="banner" value="{{ old('banner') }}" required maxlength="500" placeholder="/assets/image/tournaments/banner.jpg">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="preview" value="{{ old('preview') }}" required maxlength="500" placeholder="/assets/image/tournaments/preview.jpg">
                ...
                <div class="form-group">
                    ...
                    <input type="datetime-local" class="form-control" name="started_at" value="{{ old('started_at') }}" required>
