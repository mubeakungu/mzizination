            ...
            <div class="row gap-20 masonry pos-r">
                ...
                <div class="masonry-item col-md-6">
                    <div class="bgc-white p-20 bd">
                        ...
                        <div class="mT-30">
                            <form action="/admin/promocodes/create" method="POST">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="integer" name="activation" required class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="">
                                </div>
